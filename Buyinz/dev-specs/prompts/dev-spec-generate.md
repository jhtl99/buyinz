# Prompt: Generate a Buyinz Development Specification

Paste this into the LLM call. Replace the `{{USER_STORY_DESCRIPTION}}` placeholder with the story details before running.
...
### 1. Ownership & History
- **Primary Owner:** [Name of the student/lead]
- **Secondary Owner:** [Name of collaborator/teammate]
- **Merge Date:** [Current Date or 2026-04-08]
...
- Identify team members responsible for database security.
