# Prompt: Update an Existing Buyinz Development Specification

Paste this into the LLM call. Replace the three placeholders with the existing spec markdown, the PR diff, and the current user-story context.
...
6. **Revision History:** Add an entry to a "Revision History" table at the bottom of the document with the current date, a summary of the code change, and the PR number.
